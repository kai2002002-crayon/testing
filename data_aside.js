...
const ASIDE_DATA = {
    ...
    "Sylla": { 
     ...
     "Tig": { 
        asideIcon: "", 
        totalName: { zh: "謙遜的蒂亞娜", ja: "", en: "" }, 
        stars: {
            1: { 
                icon: "", 
                name: { zh: "蒂亞娜的掌門弟子", ja: "", en: "" }, 
                desc: { zh: "穿戴者的最大HP、物理攻擊力、爆擊、爆擊傷害增加。", ja: "", en: "" }, 
                effects: { zh: ["最大HP增加:6%", "理攻擊力增加:6%", "爆擊增加:6%", "爆擊傷害增加:6%"], ja: [""], en: [""] } 
            },
            2: { 
                icon: "", 
                name: { zh: "恩師蒂亞娜", ja: "", en: "" }, 
                desc: { zh: "增加提格、虛波、班尼對敵人造成的傷害量與攻擊速度。發動超載時,於一定時間內進入無敵狀態。", ja: "", en: "" }, 
                effects: { zh: ["無敵:對所有傷害和減益效果免疫。", "造成的傷害量增加:30%", "攻擊速度提升:25%", "無敵持續時間:3秒"], ja: [""], en: [""] } 
            },
            3: { 
                icon: "", 
                name: { zh: "下任村長提格", ja: "", en: "" }, 
                desc: { zh: "增加前排友軍對敵人造成的傷害量,並提升前排友軍的攻擊速度。", ja: "", en: "" }, 
                effects: { zh: ["造成的傷害量增加:14%", "攻擊速度提升:5%"], ja: [""], en: [""] }, 
