...
const ASIDE_DATA = {
    ...
    "Chloe": { 
        ...
        totalName: { zh: "時尚封面庫洛艾", ja: "日文願像總名稱", en: "English Total Name" }, 
        stars: {
            1: { 
                icon: "https://i.postimg.cc/w7Jh6gd0/Aside-Skill-Chloe-1.png", 
                name: { zh: "名人庫洛艾", ja: "日文1星名稱", en: "English 1-Star Name" }, 
            ...
            2: { 
                ...
                name: { zh: "F/W 庫洛艾穿搭", ja: "日文2星名稱", en: "English 2-Star Name" }, 
                desc: { zh: "免疫昏迷與變異。受到14次直接傷害時,會挑釁周圍敵人並造成範圍魔法傷害。發動玩偶的意志時,一定時間內攻擊速度提升,且每秒恢復HP。", ja: "日文2星描述", en: "English 2-Star Desc" }, 
                effects: { zh: ["昏迷:無法進行任何行動。", "變異:使目標變成物品並且無法進行任何行動。", "直接傷害:指狀態異常傷害、反射傷害以外的直接攻擊傷害。", "挑釁:使目標對發動挑釁的單位進行基本攻擊。", "玩偶的意志:改變基本攻擊效果。", "挑戰持續時間:3秒", "魔法傷害:300%", "攻擊速度提升: 30%", "攻擊速度提升持續時間:7秒", "每秒HP恢復:最大HP的1%", "每秒HP恢復持續時間:7秒"], ja: ["効果1"], en: ["Effect 1"] } 
            },
            3: { 
                icon: "https://i.postimg.cc/4YgpyqJp/Aside-Skill-Chloe-3.png", 
                name: { zh: "伸展台開場", ja: "日文3星名稱", en: "English 3-Star Name" }, 
                desc: { zh: "增加前排友軍對敵人造成的傷害量,並減少前排友軍受到敵人的傷害量。", ja: "日文3星描述", en: "English 3-Star Desc" }, 
                effects: { zh: ["傷害量增加:19.5%", "受到的傷害量減少:8.8%"], ja: ["効果1"], en: ["Effect 1"] }, 
                globalEffects: { zh: ["全體魔法防禦力 4%", "全體爆擊抵抗 4%"], ja: ["ステータスボーナス1"], en: ["Global Stat Bonus 1"] } 
            }
        }
    },
    "Diana": { 
    ...
    "Ed": { 
        ...
        stars: {
            1: { 
                ...
                name: { zh: "心地善良的伊德", ja: "日文1星名稱", en: "English 1-Star Name" }, 
                desc: { zh: "[穿戴者的最大HP、物理防禦力、魔法防禦力、 爆擊抵抗、爆擊傷害抵抗增加。", ja: "日文1星描述", en: "English 1-Star Desc" }, 
            ...
            2: { 
                ...
                name: { zh: "未醒之夢", ja: "日文2星名稱", en: "English 2-Star Name" }, 
                desc: { zh: "使用強化攻擊時,在一段時間內增加自己的防禦力。使用普通技能時,額外赋予剩下HP比例最低的友軍護盾。恢復觸發保護友軍的SP。", ja: "日文2星描述", en: "English 2-Star Desc" }, 
                effects: { zh: ["保護:因直接傷害陷入無法戰鬥狀態時,該傷害將被無效化並賦予護盾。", "直接傷害:指狀態異常傷害、反射傷害以外的直接攻擊傷害。", "防禦力增加:25%", "防禦力增加持續時間:5秒", "護盾:最大HP的50%", "護盾持續時間:8秒", "友軍SP恢復:30%"], ja: ["効果1"], en: ["Effect 1"] } 
            },
            3: { 
                icon: "https://i.postimg.cc/dhYG3pq5/Aside-Skill-Ed-3.png", 
                name: { zh: "共同的夢", ja: "日文3星名稱", en: "English 3-Star Name" }, 
                desc: { zh: "增加所有友軍的最大HP。", ja: "日文3星描述", en: "English 3-Star Desc" }, 
                effects: { zh: ["最大HP增加:18%"], ja: ["効果1"], en: ["Effect 1"] }, 
                globalEffects: { zh: ["全體 HP 4%", "全體爆擊抵抗 4%"], ja: ["ステータスボーナス1"], en: ["Global Stat Bonus 1"] } 
            }
        }
    },
    "Haley": { 
